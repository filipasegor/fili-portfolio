        ...
        <section className={styles.content}>
          ...
          <Statement text="проблемы">
            ...
            <Par>
              ...
              искать другой вклад и открывать каждую страницу по очереди
            </Par>
          </Statement>
          ...
          <Statement text="Исследования">
            ...
            <Par>1. Большой процент по отказамБольшой процент по отказам.</Par>
            <Par>
              2. После получения отказа менеджеры начинают нервничать и судрожно
              подыскивать другой вклад с другими условиями.
            </Par>
            <Par>
              3. Рядовые менеджеры часто точно не знают какого вклада наиболее
              выгодные условия и выбирают наугад либо в самый популярный.
            </Par>
            <Par>
              И как результат — большой процентов отказов во время консультации.
            </Par>
          </Statement>
          ...
          <Statement text="Решение">
            ...
            <Par>
              ...
              консультацию более информативнее и короче, я предложил объединить
              все вклады в одну страницу. А раньше у каждого вклада была
              отдельная страница.
            </Par>
            <Par>
              Клиент вводит сумму взноса, срок, и система сразу подбирает ему
          ...
          <Statement text=" ">
            ...
            <Par>
              ...
              достаточными финансовыми заниями и часто не осведомлены условиями
              открытия вклада. И потому предлагают вклады вклиентам, по своему
              усмотрению, либо опираясь мнение своих коллег.
            </Par>
            <Par>
          ...
          <Statement text="Результат">
            ...
            <div className={styles.stasWrapper}>
              ...
              <Stats
                headline="+9.1%"
                desc="Выросло количество окрытых вкладов в по результатам за апрель-август 2022 г."
              />
            </div>
            <Stats
              headline="≈ 7-9 мин."
