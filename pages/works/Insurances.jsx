        ...
        <section className={styles.content}>
          ...
          <Statement text="проблемы">
            ...
            <Par>
              ...
              калькуляторе. Но проблема в том, что клиенты приходят открыть не
              одну страховую программу, а несколько, и поэтому приходилось
              постоянно открывать новые страницы. Это сильно усложняло и
              удлиняло процесс.
            </Par>
            <Par>
              ...
              потому что офомление страховок было на разных страницах.
            </Par>
            <Par>
              Как результат менеджеры не могли предложить защиту нескольких сфер
              жизни и рассказать о выгоде цельного решения под ключ
            </Par>
          </Statement>
          ...
          <Statement text="Исследования">
            ...
            <Par>
              ...
              нужна страховка на год, а кому-то хватит на месяц или 3 месяца.
            </Par>
            <Par>
              В старом же сценарии была возможнось приобрести защиту только на
          ...
          <Statement text=" ">
            ...
            <Par>
              Так, алгоритм подсказывает менеджеру, какая защита будет актуальна
              клиенту.
            </Par>
          </Statement>
          ...
          <Statement text=" ">
            ...
            <Par>
              Это помогает менеджеру выстроить правильный диалог с клиентом
            </Par>
          </Statement>
          ...
          <Statement text=" ">
            ...
            <Par>
              ...
              более адаптивным к потребностям клиентов.
            </Par>
          </Statement>
          ...
          <Statement text="Результаты">
            ...
            <div className={styles.stasWrapper}>
              ...
              <Stats
                headline="+12.7%"
                desc="Выросло количество окрытых страховых продуктов по результатам за осень 2022 г."
              />
            </div>
            <Stats headline="-15%" desc="Уменьшился процент по отказам" />
          </Statement>

          <ProjectFooter date="08.06.2023" />
        </section>
