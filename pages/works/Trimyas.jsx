      ...
      <div className={styles.container}>
        ...
        <section className={styles.content}>
          <TaskDescLayout>
            ...
            <TaskLink>
              <Link
                href="https://tolyatty.ru/text/longread/2021/11/02/70230482/"
          ...
          <Media label="false" media="img" src={animals} />
          ...
          <Media label="false" media="img" src={salami} />

          <Media label="false" media="img" src={packs} />

          <Media label="true" media="img" src={billboard} right="right">
            <p>
              <FormattedMessage id="trimyasUsage" />
            </p>
          </Media>

          <Media label="false" media="img" src={posters} />

          <Media label="false" media="img" src={billboard1} />

          <Media label="false" media="img" src={wood} />

          <Media label="false" media="img" src={meatroll} />

          <Media
            srcThumb={thumbSausages}
            altThumb="thumbCast"
            label="false"
            media="video"
