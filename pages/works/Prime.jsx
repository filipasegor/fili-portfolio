      ...
      <div className={styles.container}>
        ...
        <section className={styles.content}>
          ...
          <Statement text="проблемы">
            ...
            <Par>Клиенты не понимают разницу от подписки Прайм и Прайм+</Par>
          ...
          <Statement text="Исследования">
            ...
            <Par>
              ...
              была им удобнее потому что на ней располагалось больше информации,
              таким образом менеджеры могли фокусировать внимание клиента на
              конкретных сервисах и на конкретной пользе от продукта
            </Par>
            <Image src={paper}></Image>
            <Par>
              Поэтому я решил позаимствовать лучшее от бумажной распечатки:
              плотность и расположение информации
            </Par>
          </Statement>
          ...
          <Statement text="Решение">
            ...
            <Par>
              ...
              планшета, так, клиент сразу видит все пользу от подписки
            </Par>
            <Par>
          ...
          <Statement text="Результат">
            <Headline>
              В итоге все основные задачи редизайна были достигнуты
            </Headline>
          </Statement>
          ...
          <div className={styles.doubleMediaWrapper}>
            <DoubleMedia
              ...
              <Point type="crosshairIcon">
                ...
                <span style={{ fontFamily: "RooftopBold" }}>от 10 минут</span>
              </Point>
              <Point type="crosshairIcon">
                Большой процент отказов и низкий уровень продаж для целевого
                продукта
            ...
            <DoubleMedia
              ...
              <Point type="tickIcon" bold="от 10 минут">
                ...
                <span style={{ fontFamily: "RooftopBold" }}>+9%</span>,а отказы
                сократились на{" "}
