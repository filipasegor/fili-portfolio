    ...
    <>
      <div className={styles.container}>
        ...
        <section className={styles.content}>
          ...
          <Media label="false" media="img" src={logo} />
          ...
          <Media label="false" media="img" src={cards} />

          <Media label="false" media="img" src={paper} />

          <Media label="false" media="img" src={box} />

          <Media label="true" media="img" right="right" src={boxes}>
            <p>
              <FormattedMessage id="deffElements" />
            </p>
          </Media>

          <Media media="img" src={bag} />

          <Media label="true" media="img" left="left" src={cardboard}>
            <p>
              <FormattedMessage id="deffPeopleLike" />
            </p>
          </Media>

          <Media label="false" media="img" src={ad} />

          <Media label="false" media="img" src={sink} />
