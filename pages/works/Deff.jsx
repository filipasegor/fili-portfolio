      ...
      <div className={styles.container}>
        ...
        <section className={styles.content}>
          ...
          <DescriptionLayout>
            ...
            <DescriptionPar>
            В знаке сочетаются красивый водоворот и первая буква в названии бренда, образуя уникальный элемент. Таким образом логотип передает суть того, для чего нужна сантехника в доме. Также этот элемент легко подстраивается под любой физический носитель и делает его контрастным к прочим  и узнаваемым для зрителя.
            </DescriptionPar>
          </DescriptionLayout>
          ...
          >
          <p>
            Фирменные элементы оформляют упаковку и легко подстраиваются под разные типы продукции: премиум товары,  небольшие размеры сантехники или товары запакованные
            в простой пакет или бумагу.
          </p>
          </Media>
          ...
          >
          <p>
            Людям нравятся коробочки на всех этапах покупки и они  нетерпеливо ждут доставку, чтобы ее поскорее распаковать.
          </p>
          </Media>
