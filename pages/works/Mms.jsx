    ...
    <>
      <div className={styles.container}>
        ...
        <section className={styles.content}>
          ...
          <Media label="false" media="img" src={sign3} />

          <Media label="false" media="img" src={billboard} />

          <Media label="false" media="img" src={stairs} />

          <Media label="false" media="img" src={wear} />

          <Media label="false" media="img" src={bus} />

          <Media label="false" media="img" src={two} />

          <Media label="true" media="img" right="right" src={card}>
            <p>
              <FormattedMessage id="mmcPaper" />
            </p>
          </Media>

          <Media label="false" media="img" src={paper} />

          <Media label="false" media="img" src={mail} />

          <Media label="true" media="img" left="left" src={eng}>
            <p>
              <FormattedMessage id="mmcLatin" />
            </p>
          </Media>

          <Media label="true" media="img" right="right" src={sign2}>
            <p>
              <FormattedMessage id="mmcArrow" />
            </p>
          </Media>

          <Media label="false" media="img" src={wall} />

          <Media label="false" media="img" src={arrow} />
