      ...
      <div className={styles.container}>
        ...
        <section className={styles.content}>
          ...
          <Statement text="Задача">
            <Headline>
              Объединить всех действий менеджера в одну систему
            </Headline>
            <Par>
              СБОЛ Про — это цифровая система работы для сотрудников, с помощью
              которой они консультируют клиентов, продают услуги и сервисы
              Сбера, ведут учет продаж, оформляют сделки, анализируют информацию
              о клиенте и выполняют все остальные функции, которые могут
              понадобиться для клиента
            </Par>
          ...
          <Statement text="Проблемы">
            ...
            <Par>
              В систему подбора продутов входит более 123 разных продуктов. У
          ...
          <Statement text=" ">
            ...
            <Par>
              ...
              сборки, структура презентацийи требования к редактуре. Любой
              дизайнер из другой команды дизайнер теперь может воспользоваться
              нашей системой и самостоятельно собрать лендинг или презентацию
            </Par>
          </Statement>
          ...
          <Statement text="Результаты">
            ...
            <Par>Также есть другие аналитические данные показатели:</Par>
            <div className={styles.stasWrapper}>
              ...
              <Stats
                headline="109"
                desc="Всего хранится уникальных продуктовых сценариев в системе"
              />
            </div>
            <Stats
              headline="В 3 раза"
